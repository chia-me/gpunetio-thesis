 ...
 * @ingroup DOCA_COMCH
 *
 * DOCA Communication Channel MsgQ library allows you to set a direct communication channel between Host/DPU and DPA.
 ...
 * - DOCA_ERROR_NO_MEMORY - failed to alloc doca_comch_msgq.
 */
DOCA_EXPERIMENTAL
 ...
 * Error code - in case of failure:
 * - DOCA_ERROR_INVALID_VALUE - input parameter is a NULL pointer.
 * - DOCA_ERROR_BAD_STATE - msgq is already started.
 */
DOCA_EXPERIMENTAL
 ...
 * DOCA_SUCCESS - in case of success.
 * Error code - in case of failure:
 * - DOCA_ERROR_INVALID_VALUE - input parameter is a NULL pointer or DPA is not initialized.
 * - DOCA_ERROR_BAD_STATE - msgq is already started.
 * - DOCA_ERROR_NOT_SUPPORTED - unsupported combination of producer/consumers attempted.
 * - DOCA_ERROR_NO_MEMORY - memory failure in resource allocation.
 */
DOCA_EXPERIMENTAL
 ...
 * Error code - in case of failure:
 * - DOCA_ERROR_INVALID_VALUE - input parameter is a NULL pointer.
 * - DOCA_ERROR_BAD_STATE - msgq is already stopped.
 * - DOCA_ERROR_IN_USE - producers or consumers are still active on msgq.
 */
DOCA_EXPERIMENTAL
 ...
 * DOCA_SUCCESS - in case of success.
 * Error code - in case of failure:
 * - DOCA_ERROR_INVALID_VALUE - input parameter is a NULL pointer or number of consumers is at max.
 * - DOCA_ERROR_BAD_STATE - msgq is not started.
 * - DOCA_ERROR_NO_MEMORY - failed to allocate consumer.
 */
DOCA_EXPERIMENTAL
 ...
 * DOCA_SUCCESS - in case of success.
 * Error code - in case of failure:
 * - DOCA_ERROR_INVALID_VALUE - input parameter is a NULL pointer or number of producers is at max.
 * - DOCA_ERROR_BAD_STATE - msgq is not started.
 * - DOCA_ERROR_NO_MEMORY - failed to allocate producer.
 */
DOCA_EXPERIMENTAL
