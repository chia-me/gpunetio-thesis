...
/**
 * @brief Configure the doca_comch callback for receiving consumer events on server context.
 *
 * @param [in] comch_server
 * Pointer to doca_comch_server instance.
 ...
 * doca_error code - in case of failure:
 * - DOCA_ERROR_INVALID_VALUE - in case one of the arguments is NULL.
 * - DOCA_ERROR_BAD_STATE - doca_comch_service context state is not idle.
 */
DOCA_STABLE
...
/**
 * @brief Configure the doca_comch callback for receiving consumer events on client context.
 *
 * @param [in] comch_client
 * Pointer to doca_comch_client instance.
 * @param [in] new_consumer_event_cb
