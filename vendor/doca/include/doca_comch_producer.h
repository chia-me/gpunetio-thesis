...
/* Opaque structure representing a GPU Producer context */
...
/**
 * @brief Retrieve the handle in the GPU memory space of a doca_comch_producer
 *
 * @param [in] producer
 * doca_comch_producer context to get the GPU handle from.
 * @param [out] gpu_producer
 ...
 */
DOCA_EXPERIMENTAL
doca_error_t doca_comch_producer_get_gpu_handle(struct doca_comch_producer *producer,
						struct doca_comch_gpu_producer **gpu_producer);
