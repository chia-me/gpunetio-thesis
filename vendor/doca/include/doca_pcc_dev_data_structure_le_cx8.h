...
#ifndef DOCA_PCC_DEV_DATA_STRUCTURE_LE_CX8_H_
#define DOCA_PCC_DEV_DATA_STRUCTURE_LE_CX8_H_
...
struct mlnx_cc_roce_tx_t {	/* Little Endian */
	...
	/* access: RW */
	/*----------------------------------------------------------*/
    unsigned char			reserved_at_40[8];
	/* access: RW */
/* --------------------------------------------------------- */
};
...
struct mlnx_cc_event_general_attr_t {	/* Little Endian */
	...
	/* access: RW */
    uint32_t			plane_num:4;			/* plane num */
	/* access: RW */
...
#endif /* DOCA_PCC_DEV_DATA_STRUCTURE_LE_CX8_H_ */
