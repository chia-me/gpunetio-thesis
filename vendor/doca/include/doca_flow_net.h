...
#define DOCA_FLOW_PROTO_IB_BTH (16)		/**< Base Transport Header Protocol */
...
#define DOCA_FLOW_ROCEV2_DEFAULT_PORT (4791)	/**< default ROCEV2 port id. */
...
#define DOCA_FLOW_ETHER_TYPE_ARP (0x0806)  /**< ARP Protocol */
...
#define DOCA_FLOW_ETHER_TYPE_SLOW (0x8809) /**< Slow protocols (LACP and Marker). */
...
#define DOCA_FLOW_IB_BTH_DST_QP_LEN 3 /**< bth destination queue pair length in bytes */
#define DOCA_FLOW_IB_BTH_PSN_LEN 3    /**< bth PSN length in bytes */
...
/**
 * @brief doca flow BTH header in match data
 */
...
/**
 * @brief doca flow ROCEv2 header in match data
 */
