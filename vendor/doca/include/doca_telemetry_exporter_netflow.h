...
/**
 * @file doca_telemetry_exporter_netflow.h
 * @page telemetry_exporter_netflow
 * @defgroup DOCA_TELEMETRY_EXPORTER_NETFLOW DOCA Telemetry NetFlow
 * @ingroup DOCA_TELEMETRY_EXPORTER
 *
...
#ifndef DOCA_TELEMETRY_EXPORTER_NETFLOW_H_
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_H_

#include <stddef.h>
#include <stdint.h>

#include <doca_telemetry_exporter_netflow_types.h>
...
/**
 * @brief One field in netflow template, please refer to doca_telemetry_exporter_netflow_types.h for type macros
 */
struct doca_telemetry_exporter_netflow_flowset_field;
 ...
 * }
 * doca_telemetry_exporter_netflow_template_create(&temp)
 *
 * doca_telemetry_exporter_netflow_field_create(&field1);
 * doca_telemetry_exporter_netflow_field_create(&field2);
 *
 * doca_telemetry_exporter_netflow_field_set_type(field1, DOCA_NETFLOW_IPV4_SRC_ADDR);
 * doca_telemetry_exporter_netflow_field_set_len(field1. DOCA_NETFLOW_IPV4_SRC_ADDR_DEFAULT_LENGTH);
 *
 * doca_telemetry_exporter_netflow_field_set_type(field1, DOCA_NETFLOW_IPV4_DST_ADDR);
 * doca_telemetry_exporter_netflow_field_set_len(field1. DOCA_NETFLOW_IPV4_DST_ADDR_DEFAULT_LENGTH);
 *
 * doca_telemetry_exporter_netflow_template_add_field(temp, field1);
 * doca_telemetry_exporter_netflow_template_add_field(temp, field2);

 * @note all fields are in network byte order.
 */
struct doca_telemetry_exporter_netflow_template;
 ...
 *
 * This function can be called again only after doca_telemetry_exporter_netflow_destroy was
 * called.
 *
 * @param [in] source_id
 * Unique source ID.
 ...
 *
 * @note This function should be called after doca_telemetry_exporter_netflow_init().
 */
DOCA_EXPERIMENTAL
void doca_telemetry_exporter_netflow_set_collector_addr(const char *collector_addr);
 ...
 */
DOCA_EXPERIMENTAL
void doca_telemetry_exporter_netflow_set_collector_port(uint16_t collector_port);
 ...
 */
DOCA_EXPERIMENTAL
void doca_telemetry_exporter_netflow_set_max_packet_size(uint16_t max_packet_size);
 ...
 */
DOCA_EXPERIMENTAL
doca_error_t doca_telemetry_exporter_netflow_field_create(struct doca_telemetry_exporter_netflow_flowset_field **field);
 ...
 */
DOCA_EXPERIMENTAL
void doca_telemetry_exporter_netflow_field_set_type(struct doca_telemetry_exporter_netflow_flowset_field *field,
						    uint16_t type);
 ...
 */
DOCA_EXPERIMENTAL
void doca_telemetry_exporter_netflow_field_set_len(struct doca_telemetry_exporter_netflow_flowset_field *field,
						   uint16_t length);
 ...
 */
DOCA_EXPERIMENTAL
doca_error_t doca_telemetry_exporter_netflow_field_destroy(struct doca_telemetry_exporter_netflow_flowset_field *field);
 ...
 */
DOCA_EXPERIMENTAL
void doca_telemetry_exporter_netflow_set_buf_size(uint64_t size);
 ...
 */
DOCA_EXPERIMENTAL
void doca_telemetry_exporter_netflow_set_buf_data_root(const char *path);
 ...
 */
DOCA_EXPERIMENTAL
doca_error_t doca_telemetry_exporter_netflow_template_create(
 ...
 */
DOCA_EXPERIMENTAL
doca_error_t doca_telemetry_exporter_netflow_template_add_field(
	struct doca_telemetry_exporter_netflow_template *netflow_template,
 ...
 */
DOCA_EXPERIMENTAL
doca_error_t doca_telemetry_exporter_netflow_template_destroy(
	struct doca_telemetry_exporter_netflow_template *netflow_template);
 ...
 */
DOCA_EXPERIMENTAL
void doca_telemetry_exporter_netflow_set_file_write_enabled(void);
 ...
 */
DOCA_EXPERIMENTAL
void doca_telemetry_exporter_netflow_set_file_write_max_size(size_t size);
 ...
 */
DOCA_EXPERIMENTAL
void doca_telemetry_exporter_netflow_set_file_write_max_age(doca_telemetry_exporter_timestamp_t max_age);
 ...
 */
DOCA_EXPERIMENTAL
void doca_telemetry_exporter_netflow_set_ipc_enabled(void);
 ...
 */
DOCA_EXPERIMENTAL
void doca_telemetry_exporter_netflow_set_ipc_sockets_dir(const char *path);
 ...
 */
DOCA_EXPERIMENTAL
void doca_telemetry_exporter_netflow_source_set_id(const char *source_id);
 ...
 */
DOCA_EXPERIMENTAL
void doca_telemetry_exporter_netflow_source_set_tag(const char *source_tag);
 ...
 * For more info refer to doca_telemetry_exporter_netflow_template.
 * @param [in] records
 ...
 */
DOCA_EXPERIMENTAL
doca_error_t doca_telemetry_exporter_netflow_send(
	const struct doca_telemetry_exporter_netflow_template *netflow_template,
	const void **records,
	size_t nof_records,
...
#endif /* DOCA_TELEMETRY_EXPORTER_NETFLOW_H_ */
