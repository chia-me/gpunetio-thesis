...
/* Opaque structure representing a GPU Consumer context */
 ...
 * - DOCA_ERROR_BAD_STATE - consumer is not stopped.
 */
DOCA_STABLE
 ...
 * Error code - in case of failure:
 * - DOCA_ERROR_INVALID_VALUE - input parameter is a NULL pointer.
 * - DOCA_ERROR_NO_MEMORY - failed to alloc doca_comch_consumer_completion object.
 */
DOCA_EXPERIMENTAL
 ...
 * Error code - in case of failure:
 * - DOCA_ERROR_INVALID_VALUE - in case of invalid input.
 * - DOCA_ERROR_BAD_STATE - consumer completion is already started.
 */
DOCA_EXPERIMENTAL
 ...
 * DOCA_SUCCESS - in case of success.
 * Error code - in case of failure:
 * - DOCA_ERROR_INVALID_VALUE - consumer_comp argument is a NULL pointer.
 * - DOCA_ERROR_BAD_STATE - consumer completion is not stopped.
 */
DOCA_EXPERIMENTAL
 ...
 * DOCA_SUCCESS - in case of success.
 * Error code - in case of failure:
 * - DOCA_ERROR_INVALID_VALUE - consumer_comp argument is a NULL pointer or DPA is not initialized.
 * - DOCA_ERROR_BAD_STATE - consumer completion is already started.
 * - DOCA_ERROR_NO_MEMORY - DPA memory allocation failure.
 */
DOCA_EXPERIMENTAL
 ...
 * Error code - in case of failure:
 * - DOCA_ERROR_INVALID_VALUE - consumer_comp argument is a NULL pointer or DPA is not initialized.
 * - DOCA_ERROR_BAD_STATE - consumer completion is already stopped.
 * - DOCA_ERROR_IN_USE - consumers are still associated with the completion.
 */
DOCA_EXPERIMENTAL
 ...
 * DOCA_SUCCESS - in case of success.
 * Error code - in case of failure:
 * - DOCA_ERROR_INVALID_VALUE - NULL parameter input.
 * - DOCA_ERROR_BAD_STATE - consumer completion is not started.
 */
DOCA_EXPERIMENTAL
 ...
 * DOCA_SUCCESS - in case of success.
 * Error code - in case of failure:
 * - DOCA_ERROR_INVALID_VALUE - NULL pointer or out of range input.
 * - DOCA_ERROR_BAD_STATE - consumer completion is already started.
 */
DOCA_EXPERIMENTAL
 ...
 * Error code - in case of failure:
 * - DOCA_ERROR_INVALID_VALUE - in case of invalid input.
 * - DOCA_ERROR_BAD_STATE - completion instance is already started.
 */
DOCA_EXPERIMENTAL
 ...
 * Error code - in case of failure:
 * - DOCA_ERROR_INVALID_VALUE - NULL pointer or out of range input.
 * - DOCA_ERROR_BAD_STATE - consumer is already started.
 */
DOCA_EXPERIMENTAL
 ...
 * Error code - in case of failure:
 * - DOCA_ERROR_INVALID_VALUE - in case of invalid input.
 * - DOCA_ERROR_BAD_STATE - consumer is already started or consumer completion is not started.
 */
DOCA_EXPERIMENTAL
...
/**
 * @brief Retrieve the handle in the GPU memory space of a doca_comch_consumer
 *
 * @param [in] consumer
 * doca_comch_consumer context to get the GPU handle from.
 * @param [out] gpu_consumer
 ...
 */
DOCA_EXPERIMENTAL
doca_error_t doca_comch_consumer_get_gpu_handle(struct doca_comch_consumer *consumer,
						struct doca_comch_gpu_consumer **gpu_consumer);
