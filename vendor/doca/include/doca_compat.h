 ...
 * @file doca_compat.h
 * @page compat
 * @defgroup DOCA_COMPAT DOCA Compatibility Management
 *
...
/**
 * @brief Attribute for marking deprecated enum constants (enumerators).
 * Honours DOCA_ALLOW_DEPRECATED_API to suppress warnings when requested.
 */
#define DOCA_DEPRECATED_ENUM __attribute__((deprecated("Enum is defined as deprecated")))

#else /* DOCA_ALLOW_DEPRECATED_API */

#define DOCA_DEPRECATED __attribute__((section(".text.deprecated"))) DOCA_STABLE
#define DOCA_DEPRECATED_ENUM
 ...
 * Honours DOCA_ALLOW_DEPRECATED_API to suppress warnings when requested.
 */
#define DOCA_DEPRECATED_ENUM __declspec(deprecated("Enum is defined as deprecated"))
