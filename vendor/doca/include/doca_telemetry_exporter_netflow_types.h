...
#ifndef DOCA_TELEMETRY_EXPORTER_NETFLOW_TYPES_H_
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_TYPES_H_

/**
 * Incoming counter with length N x 8 bits for number of bytes associated with an IP Flow.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IN_BYTES 1
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IN_BYTES_DEFAULT_LENGTH 4
/**
 * Incoming counter with length N x 8 bits for the number of packets associated with an IP Flow
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IN_PKTS 2
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IN_PKTS_DEFAULT_LENGTH 4
/**
 * Number of flows that were aggregated; default for N is 4
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_FLOWS 3
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_FLOWS_DEFAULT_LENGTH 4
/**
 * IP protocol byte
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_PROTOCOL 4
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_PROTOCOL_DEFAULT_LENGTH 1
/**
 * Type of Service byte setting when entering incoming interface
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SRC_TOS 5
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SRC_TOS_DEFAULT_LENGTH 1
/**
 * Cumulative of all the TCP flags seen for this flow
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_TCP_FLAGS 6
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_TCP_FLAGS_DEFAULT_LENGTH 1
/**
 * TCP/UDP source port number i.e.: FTP, Telnet, or equivalent
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_L4_SRC_PORT 7
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_L4_SRC_PORT_DEFAULT_LENGTH 2
/**
 * IPv4 source address
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IPV4_SRC_ADDR 8
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IPV4_SRC_ADDR_DEFAULT_LENGTH 4
/**
 * The number of contiguous bits in the source address subnet mask i.e.: the submask in slash
 * notation
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SRC_MASK 9
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SRC_MASK_DEFAULT_LENGTH 1
/**
 * Input interface index; default for N is 2 but higher values could be used
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_INPUT_SNMP 10
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_INPUT_SNMP_DEFAULT_LENGTH 2
/**
 * TCP/UDP destination port number i.e.: FTP, Telnet, or equivalent
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_L4_DST_PORT 11
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_L4_DST_PORT_DEFAULT_LENGTH 2
/**
 * IPv4 destination address
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IPV4_DST_ADDR 12
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IPV4_DST_ADDR_DEFAULT_LENGTH 4
/**
 * The number of contiguous bits in the destination address subnet mask i.e.: the submask in slash
 * notation
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DST_MASK 13
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DST_MASK_DEFAULT_LENGTH 1
/**
 * Output interface index; default for N is 2 but higher values could be used
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_OUTPUT_SNMP 14
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_OUTPUT_SNMP_DEFAULT_LENGTH 2
/**
 * IPv4 address of next-hop router
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IPV4_NEXT_HOP 15
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IPV4_NEXT_HOP_DEFAULT_LENGTH 4
/**
 * Source BGP autonomous system number where N could be 2 or 4
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SRC_AS 16
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SRC_AS_DEFAULT_LENGTH 2
/**
 * Destination BGP autonomous system number where N could be 2 or 4
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DST_AS 17
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DST_AS_DEFAULT_LENGTH 2
/**
 * Next-hop router's IP in the BGP domain
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_BGP_IPV4_NEXT_HOP 18
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_BGP_IPV4_NEXT_HOP_DEFAULT_LENGTH 4
/**
 * IP multicast outgoing packet counter with length N x 8 bits for packets associated with the IP
 * Flow
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MUL_DST_PKTS 19
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MUL_DST_PKTS_DEFAULT_LENGTH 4
/**
 * IP multicast outgoing byte counter with length N x 8 bits for bytes associated with the IP Flow
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MUL_DST_BYTES 20
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MUL_DST_BYTES_DEFAULT_LENGTH 4
/**
 * System uptime at which the last packet of this flow was switched
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_LAST_SWITCHED 21
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_LAST_SWITCHED_DEFAULT_LENGTH 4
/**
 * System uptime at which the first packet of this flow was switched
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_FIRST_SWITCHED 22
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_FIRST_SWITCHED_DEFAULT_LENGTH 4
/**
 * Outgoing counter with length N x 8 bits for the number of bytes associated with an IP Flow
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_OUT_BYTES 23
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_OUT_BYTES_DEFAULT_LENGTH 4
/**
 * Outgoing counter with length N x 8 bits for the number of packets associated with an IP Flow.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_OUT_PKTS 24
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_OUT_PKTS_DEFAULT_LENGTH 4
/**
 * Minimum IP packet length on incoming packets of the flow
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MIN_PKT_LENGTH 25
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MIN_PKT_LENGTH_DEFAULT_LENGTH 2
/**
 * Maximum IP packet length on incoming packets of the flow
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MAX_PKT_LENGTH 26
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MAX_PKT_LENGTH_DEFAULT_LENGTH 2
/**
 * IPv6 Source Address
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IPV6_SRC_ADDR 27
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IPV6_SRC_ADDR_DEFAULT_LENGTH 16
/**
 * IPv6 Destination Address
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IPV6_DST_ADDR 28
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IPV6_DST_ADDR_DEFAULT_LENGTH 16
/**
 * Length of the IPv6 source mask in contiguous bits
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IPV6_SRC_MASK 29
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IPV6_SRC_MASK_DEFAULT_LENGTH 1
/**
 * Length of the IPv6 destination mask in contiguous bits
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IPV6_DST_MASK 30
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IPV6_DST_MASK_DEFAULT_LENGTH 1
/**
 * IPv6 flow label as per RFC 2460 definition
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IPV6_FLOW_LABEL 31
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IPV6_FLOW_LABEL_DEFAULT_LENGTH 3
/**
 * Internet Control Message Protocol (ICMP) packet type; reported as ((ICMP Type*256) + ICMP code)
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_ICMP_TYPE 32
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_ICMP_TYPE_DEFAULT_LENGTH 2
/**
 * Internet Group Management Protocol (IGMP) packet type
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MUL_IGMP_TYPE 33
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MUL_IGMP_TYPE_DEFAULT_LENGTH 1
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SAMPLING_INTERVAL 34
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SAMPLING_INTERVAL_DEFAULT_LENGTH 4
/**
 * The type of algorithm used for sampled NetFlow: 0x01 Deterministic Sampling ,0x02 Random Sampling
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SAMPLING_ALGORITHM 35
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SAMPLING_ALGORITHM_DEFAULT_LENGTH 1
/**
 * Timeout value (in seconds) for active flow entries in the NetFlow cache
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_FLOW_ACTIVE_TIMEOUT 36
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_FLOW_ACTIVE_TIMEOUT_DEFAULT_LENGTH 2
/**
 * Timeout value (in seconds) for inactive flow entries in the NetFlow cache
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_FLOW_INACTIVE_TIMEOUT 37
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_FLOW_INACTIVE_TIMEOUT_DEFAULT_LENGTH 2
/**
 * Type of flow switching engine: RP = 0, VIP/Linecard = 1
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_ENGINE_TYPE 38
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_ENGINE_TYPE_DEFAULT_LENGTH 1
/**
 * ID number of the flow switching engine
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_ENGINE_ID 39
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_ENGINE_ID_DEFAULT_LENGTH 1
/**
 * Counter with length N x 8 bits for bytes for the number of bytes exported by the Observation
 * Domain
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_TOTAL_BYTES_EXP 40
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_TOTAL_BYTES_EXP_DEFAULT_LENGTH 4
/**
 * Counter with length N x 8 bits for bytes for the number of packets exported by the Observation
 * Domain
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_TOTAL_PKTS_EXP 41
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_TOTAL_PKTS_EXP_DEFAULT_LENGTH 4
/**
 * Counter with length N x 8 bits for bytes for the number of flows exported by the Observation
 * Domain
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_TOTAL_FLOWS_EXP 42
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_TOTAL_FLOWS_EXP_DEFAULT_LENGTH 4
/**
 * IPv4 source address prefix (specific for Catalyst architecture)
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IPV4_SRC_PREFIX 44
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IPV4_SRC_PREFIX_DEFAULT_LENGTH 4
/**
 * IPv4 destination address prefix (specific for Catalyst architecture)
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IPV4_DST_PREFIX 45
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IPV4_DST_PREFIX_DEFAULT_LENGTH 4
/**
 * MPLS Top Label Type: 0x00 UNKNOWN 0x01 TE-MIDPT 0x02 ATOM 0x03 VPN 0x04 BGP 0x05 LDP
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MPLS_TOP_LABEL_TYPE 46
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MPLS_TOP_LABEL_TYPE_DEFAULT_LENGTH 1
/**
 * Forwarding Equivalent Class corresponding to the MPLS Top Label
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MPLS_TOP_LABEL_IP_ADDR 47
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MPLS_TOP_LABEL_IP_ADDR_DEFAULT_LENGTH 4
/**
 * Identifier shown in "show flow-sampler"
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_FLOW_SAMPLER_ID 48
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_FLOW_SAMPLER_ID_DEFAULT_LENGTH 1
/**
 * The type of algorithm used for sampling data: 0x02 random sampling. Use in connection with
 * FLOW_SAMPLER_MODE
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_FLOW_SAMPLER_MODE 49
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_FLOW_SAMPLER_MODE_DEFAULT_LENGTH 1
/**
 * Packet interval at which to sample. Use in connection with FLOW_SAMPLER_MODE
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_FLOW_SAMPLER_RANDOM_INTERVAL 50
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_FLOW_SAMPLER_RANDOM_INTERVAL_DEFAULT_LENGTH 4
/**
 * Minimum TTL on incoming packets of the flow
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MIN_TTL 52
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MIN_TTL_DEFAULT_LENGTH 1
/**
 * Maximum TTL on incoming packets of the flow
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MAX_TTL 53
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MAX_TTL_DEFAULT_LENGTH 1
/**
 * The IP v4 identification field
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IPV4_IDENT 54
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IPV4_IDENT_DEFAULT_LENGTH 2
/**
 * Type of Service byte setting when exiting outgoing interface
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DST_TOS 55
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DST_TOS_DEFAULT_LENGTH 1
/**
 * Incoming source MAC address
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IN_SRC_MAC 56
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IN_SRC_MAC_DEFAULT_LENGTH 6
/**
 * Outgoing destination MAC address
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_OUT_DST_MAC 57
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_OUT_DST_MAC_DEFAULT_LENGTH 6
/**
 * Virtual LAN identifier associated with ingress interface
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SRC_VLAN 58
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SRC_VLAN_DEFAULT_LENGTH 2
/**
 * Virtual LAN identifier associated with egress interface
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DST_VLAN 59
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DST_VLAN_DEFAULT_LENGTH 2
/**
 * Internet Protocol Version Set to 4 for IPv4, set to 6 for IPv6. If not present in the template,
 * then version 4 is assumed.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IP_PROTOCOL_VERSION 60
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IP_PROTOCOL_VERSION_DEFAULT_LENGTH 1
/**
 * Flow direction: 0 - ingress flow, 1 - egress flow
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DIRECTION 61
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DIRECTION_DEFAULT_LENGTH 1
/**
 * IPv6 address of the next-hop router
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IPV6_NEXT_HOP 62
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IPV6_NEXT_HOP_DEFAULT_LENGTH 16
/**
 * Next-hop router in the BGP domain
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_BPG_IPV6_NEXT_HOP 63
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_BPG_IPV6_NEXT_HOP_DEFAULT_LENGTH 16
/**
 * Bit-encoded field identifying IPv6 option headers found in the flow
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IPV6_OPTION_HEADERS 64
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IPV6_OPTION_HEADERS_DEFAULT_LENGTH 4
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MPLS_LABEL_1 70
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MPLS_LABEL_1_DEFAULT_LENGTH 3
/**
 * MPLS label at position 2 in the stack. This comprises 20 bits of MPLS label, 3 EXP (experimental)
 * bits and 1 S (end-of-stack) bit.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MPLS_LABEL_2 71
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MPLS_LABEL_2_DEFAULT_LENGTH 3
/**
 * MPLS label at position 3 in the stack. This comprises 20 bits of MPLS label, 3 EXP (experimental)
 * bits and 1 S (end-of-stack) bit.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MPLS_LABEL_3 72
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MPLS_LABEL_3_DEFAULT_LENGTH 3
/**
 * MPLS label at position 4 in the stack. This comprises 20 bits of MPLS label, 3 EXP (experimental)
 * bits and 1 S (end-of-stack) bit.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MPLS_LABEL_4 73
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MPLS_LABEL_4_DEFAULT_LENGTH 3
/**
 * MPLS label at position 5 in the stack. This comprises 20 bits of MPLS label, 3 EXP (experimental)
 * bits and 1 S (end-of-stack) bit.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MPLS_LABEL_5 74
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MPLS_LABEL_5_DEFAULT_LENGTH 3
/**
 * MPLS label at position 6 in the stack. This comprises 20 bits of MPLS label, 3 EXP (experimental)
 * bits and 1 S (end-of-stack) bit.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MPLS_LABEL_6 75
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MPLS_LABEL_6_DEFAULT_LENGTH 3
/**
 * MPLS label at position 7 in the stack. This comprises 20 bits of MPLS label, 3 EXP (experimental)
 * bits and 1 S (end-of-stack) bit.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MPLS_LABEL_7 76
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MPLS_LABEL_7_DEFAULT_LENGTH 3
/**
 * MPLS label at position 8 in the stack. This comprises 20 bits of MPLS label, 3 EXP (experimental)
 * bits and 1 S (end-of-stack) bit.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MPLS_LABEL_8 77
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MPLS_LABEL_8_DEFAULT_LENGTH 3
/**
 * MPLS label at position 9 in the stack. This comprises 20 bits of MPLS label, 3 EXP (experimental)
 * bits and 1 S (end-of-stack) bit.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MPLS_LABEL_9 78
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MPLS_LABEL_9_DEFAULT_LENGTH 3
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MPLS_LABEL_10 79
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MPLS_LABEL_10_DEFAULT_LENGTH 3
/**
 * Incoming destination MAC address
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IN_DST_MAC 80
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IN_DST_MAC_DEFAULT_LENGTH 6
/**
 * Outgoing source MAC address
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_OUT_SRC_MAC 81
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_OUT_SRC_MAC_DEFAULT_LENGTH 6
/**
 * Shortened interface name i.e.: "FE1/0"
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IF_NAME 82
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IF_NAME_DEFAULT_LENGTH 64
/**
 * Full interface name i.e.: "'FastEthernet 1/0"
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IF_DESC 83
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IF_DESC_DEFAULT_LENGTH 64
/**
 * Name of the flow sampler
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SAMPLER_NAME 84
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SAMPLER_NAME_DEFAULT_LENGTH 64
/**
 * Running byte counter for a permanent flow
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IN_PERMANENT_BYTES 85
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IN_PERMANENT_BYTES_DEFAULT_LENGTH 4
/**
 * Running packet counter for a permanent flow
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IN_PERMANENT_PKTS 86
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IN_PERMANENT_PKTS_DEFAULT_LENGTH 4
/**
 * The fragment-offset value from fragmented IP packets
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_FRAGMENT_OFFSET 88
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_FRAGMENT_OFFSET_DEFAULT_LENGTH 2
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_FORWARDING_STATUS 89
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_FORWARDING_STATUS_DEFAULT_LENGTH 1
/**
 * MPLS PAL Route Distinguisher.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MPLS_PAL_RD 90
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MPLS_PAL_RD_DEFAULT_LENGTH 8
/**
 * Number of consecutive bits in the MPLS prefix length.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MPLS_PREFIX_LEN 91
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MPLS_PREFIX_LEN_DEFAULT_LENGTH 1
/**
 * BGP Policy Accounting Source Traffic Index
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SRC_TRAFFIC_INDEX 92
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SRC_TRAFFIC_INDEX_DEFAULT_LENGTH 4
/**
 * BGP Policy Accounting Destination Traffic Index
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DST_TRAFFIC_INDEX 93
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DST_TRAFFIC_INDEX_DEFAULT_LENGTH 4
/**
 * Application description.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_APPLICATION_DESCRIPTION 94
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_APPLICATION_DESCRIPTION_DEFAULT_LENGTH 64
/**
 * 8 bits of engine ID, followed by n bits of classification.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_APPLICATION_TAG 95
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_APPLICATION_TAG_DEFAULT_LENGTH 3
/**
 * Name associated with a classification.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_APPLICATION_NAME 96
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_APPLICATION_NAME_DEFAULT_LENGTH 64
/**
 * The value of a Differentiated Services Code Point (DSCP) encoded in the Differentiated Services
 * Field, after modification.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_POSTIP_DIFF_SERV_CODE_POINT 98
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_POSTIP_DIFF_SERV_CODE_POINT_DEFAULT_LENGTH 1
/**
 * Multicast replication factor.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_REPLICATION_FACTOR 99
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_REPLICATION_FACTOR_DEFAULT_LENGTH 4
/**
 * Layer 2 packet section offset. Potentially a generic offset.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_LAYER_2_PACKET_SECTION_OFFSET 102
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_LAYER_2_PACKET_SECTION_OFFSET_DEFAULT_LENGTH 2
/**
 * Layer 2 packet section size. Potentially a generic size.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_LAYER_2_PACKET_SECTION_SIZE 103
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_LAYER_2_PACKET_SECTION_SIZE_DEFAULT_LENGTH 2
/**
 * Layer 2 packet section data.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_LAYER_2_PACKET_SECTION_DATA 104
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_LAYER_2_PACKET_SECTION_DATA_DEFAULT_LENGTH 3
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_BGP_NEXT_ADJACENT_AS_NUMBER 128
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_BGP_NEXT_ADJACENT_AS_NUMBER_DEFAULT_LENGTH 4
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_BGP_PREV_ADJACENT_AS_NUMBER 129
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_BGP_PREV_ADJACENT_AS_NUMBER_DEFAULT_LENGTH 4
/**
 ...
 * proxy.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_EXPORTER_IPV4_ADDRESS 130
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_EXPORTER_IPV4_ADDRESS_DEFAULT_LENGTH 4
/**
 * The IPv6 address used by the Exporting Process. This is used by the Collector to identify the
 * Exporter in cases where the identity of the Exporter may have been obscured by the use of a
 * proxy.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_EXPORTER_IPV6_ADDRESS 131
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_EXPORTER_IPV6_ADDRESS_DEFAULT_LENGTH 8
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DROPPED_OCTET_DELTA_COUNT 132
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DROPPED_OCTET_DELTA_COUNT_DEFAULT_LENGTH 8
/**
 * The number of packets since the previous report (if any) of this Flow dropped by packet
 * treatment.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DROPPED_PACKET_DELTA_COUNT 133
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DROPPED_PACKET_DELTA_COUNT_DEFAULT_LENGTH 8
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DROPPED_OCTET_TOTAL_COUNT 134
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DROPPED_OCTET_TOTAL_COUNT_DEFAULT_LENGTH 8
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DROPPED_PACKET_TOTAL_COUNT 135
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DROPPED_PACKET_TOTAL_COUNT_DEFAULT_LENGTH 8
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_FLOW_END_REASON 136
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_FLOW_END_REASON_DEFAULT_LENGTH 1
/**
 ...
 * Data Records.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_COMMON_PROPERTIES_ID 137
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_COMMON_PROPERTIES_ID_DEFAULT_LENGTH 8
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_OBSERVATION_POINT_ID 138
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_OBSERVATION_POINT_ID_DEFAULT_LENGTH 8
/**
 * Type and Code of the IPv6 ICMP message. The combination of both values is reported as (ICMP type
 * * 256) + ICMP code.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_ICMP_TYPE_CODE_IPV6 139
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_ICMP_TYPE_CODE_IPV6_DEFAULT_LENGTH 2
/**
 * The IPv6 address of the system that the MPLS top label will cause this Flow to be forwarded to.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MPLS_TOP_LABEL_IPV6_ADDRESS 140
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MPLS_TOP_LABEL_IPV6_ADDRESS_DEFAULT_LENGTH 8
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_LINE_CARD_ID 141
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_LINE_CARD_ID_DEFAULT_LENGTH 4
/**
 * An identifier of a line port that is unique per IPFIX Device hosting an Observation Point.
 * Typically, this Information Element is used for limiting the scope of other Information Elements.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_PORT_ID 142
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_PORT_ID_DEFAULT_LENGTH 4
/**
 ...
 * different ID.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_METERING_PROCESS_ID 143
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_METERING_PROCESS_ID_DEFAULT_LENGTH 4
/**
 ...
 * with a different ID.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_EXPORTING_PROCESS_ID 144
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_EXPORTING_PROCESS_ID_DEFAULT_LENGTH 4
/**
 * An identifier of a Template that is locally unique within a combination of a Transport session
 * and an Observation Domain.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_TEMPLATE_ID 145
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_TEMPLATE_ID_DEFAULT_LENGTH 2
/**
 * The identifier of the 802.11 (Wi-Fi) channel used.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_WLAN_CHANNEL_ID 146
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_WLAN_CHANNEL_ID_DEFAULT_LENGTH 1
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_WLAN_SSID 147
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_WLAN_SSID_DEFAULT_LENGTH 64
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_FLOW_ID 148
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_FLOW_ID_DEFAULT_LENGTH 8
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_OBSERVATION_DOMAIN_ID 149
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_OBSERVATION_DOMAIN_ID_DEFAULT_LENGTH 4
/**
 * The absolute timestamp of the first packet of this Flow.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_FLOW_START_SECONDS 150
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_FLOW_START_SECONDS_DEFAULT_LENGTH 4
/**
 * The absolute timestamp of the last packet of this Flow.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_FLOW_END_SECONDS 151
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_FLOW_END_SECONDS_DEFAULT_LENGTH 4
/**
 * The absolute timestamp of the first packet of this Flow.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_FLOW_START_MILLISECONDS 152
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_FLOW_START_MILLISECONDS_DEFAULT_LENGTH 8
/**
 * The absolute timestamp of the last packet of this Flow.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_FLOW_END_MILLISECONDS 153
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_FLOW_END_MILLISECONDS_DEFAULT_LENGTH 8
/**
 * The absolute timestamp of the first packet of this Flow.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_FLOW_START_MICROSECONDS 154
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_FLOW_START_MICROSECONDS_DEFAULT_LENGTH 8
/**
 * The absolute timestamp of the last packet of this Flow.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_FLOW_END_MICROSECONDS 155
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_FLOW_END_MICROSECONDS_DEFAULT_LENGTH 8
/**
 * The absolute timestamp of the first packet of this Flow.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_FLOW_START_NANOSECONDS 156
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_FLOW_START_NANOSECONDS_DEFAULT_LENGTH 8
/**
 * The absolute timestamp of the last packet of this Flow.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_FLOW_END_NANOSECONDS 157
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_FLOW_END_NANOSECONDS_DEFAULT_LENGTH 8
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_FLOW_START_DELTA_MICROSECONDS 158
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_FLOW_START_DELTA_MICROSECONDS_DEFAULT_LENGTH 4
/**
 * This is a relative timestamp only valid within the scope of a single IPFIX Message. It contains
 * the negative time offset of the last observed packet of this Flow relative to the export time
 * specified in the IPFIX Message Header.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_FLOW_END_DELTA_MICROSECONDS 159
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_FLOW_END_DELTA_MICROSECONDS_DEFAULT_LENGTH 4
/**
 * The absolute timestamp of the last (re-)initialization of the IPFIX Device.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SYSTEM_INIT_TIME_MILLISECONDS 160
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SYSTEM_INIT_TIME_MILLISECONDS_DEFAULT_LENGTH 8
/**
 * The difference in time between the first observed packet of this Flow and the last observed
 * packet of this Flow.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_FLOW_DURATION_MILLISECONDS 161
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_FLOW_DURATION_MILLISECONDS_DEFAULT_LENGTH 4
/**
 * The difference in time between the first observed packet of this Flow and the last observed
 * packet of this Flow.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_FLOW_DURATION_MICROSECONDS 162
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_FLOW_DURATION_MICROSECONDS_DEFAULT_LENGTH 4
/**
 * The total number of Flows observed in the Observation Domain since the Metering Process
 * (re-)initialization for this Observation Point.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_OBSERVED_FLOW_TOTAL_COUNT 163
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_OBSERVED_FLOW_TOTAL_COUNT_DEFAULT_LENGTH 8
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IGNORED_PACKET_TOTAL_COUNT 164
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IGNORED_PACKET_TOTAL_COUNT_DEFAULT_LENGTH 8
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IGNORED_OCTET_TOTAL_COUNT 165
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IGNORED_OCTET_TOTAL_COUNT_DEFAULT_LENGTH 8
/**
 ...
 * policies.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_NOT_SENT_FLOW_TOTAL_COUNT 166
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_NOT_SENT_FLOW_TOTAL_COUNT_DEFAULT_LENGTH 8
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_NOT_SENT_PACKET_TOTAL_COUNT 167
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_NOT_SENT_PACKET_TOTAL_COUNT_DEFAULT_LENGTH 8
/**
 ...
 * special Flow export policies.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_NOT_SENT_OCTET_TOTAL_COUNT 168
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_NOT_SENT_OCTET_TOTAL_COUNT_DEFAULT_LENGTH 8
/**
 * IPv6 destination address prefix.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DESTINATION_IPV6_PREFIX 169
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DESTINATION_IPV6_PREFIX_DEFAULT_LENGTH 8
/**
 * IPv6 source address prefix.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SOURCE_IPV6_PREFIX 170
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SOURCE_IPV6_PREFIX_DEFAULT_LENGTH 8
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_POST_OCTET_TOTAL_COUNT 171
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_POST_OCTET_TOTAL_COUNT_DEFAULT_LENGTH 8
/**
 * The definition of this Information Element is identical to the definition of Information Element
 * 'packetTotalCount', except that it reports a potentially modified value caused by a middlebox
 * function after the packet passed the Observation Point.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_POST_PACKET_TOTAL_COUNT 172
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_POST_PACKET_TOTAL_COUNT_DEFAULT_LENGTH 8
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_FLOW_KEY_INDICATOR 173
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_FLOW_KEY_INDICATOR_DEFAULT_LENGTH 8
/**
 ...
 * means.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_POST_MCAST_PACKET_TOTAL_COUNT 174
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_POST_MCAST_PACKET_TOTAL_COUNT_DEFAULT_LENGTH 8
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_POST_MCAST_OCTET_TOTAL_COUNT 175
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_POST_MCAST_OCTET_TOTAL_COUNT_DEFAULT_LENGTH 8
/**
 * Type of the IPv4 ICMP message.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_ICMP_TYPE_IPV4 176
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_ICMP_TYPE_IPV4_DEFAULT_LENGTH 1
/**
 * Code of the IPv4 ICMP message.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_ICMP_CODE_IPV4 177
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_ICMP_CODE_IPV4_DEFAULT_LENGTH 1
/**
 * Type of the IPv6 ICMP message.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_ICMP_TYPE_IPV6 178
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_ICMP_TYPE_IPV6_DEFAULT_LENGTH 1
/**
 * Code of the IPv6 ICMP message.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_ICMP_CODE_IPV6 179
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_ICMP_CODE_IPV6_DEFAULT_LENGTH 1
/**
 * The source port identifier in the UDP header.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_UDP_SOURCE_PORT 180
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_UDP_SOURCE_PORT_DEFAULT_LENGTH 2
/**
 * The destination port identifier in the UDP header.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_UDP_DESTINATION_PORT 181
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_UDP_DESTINATION_PORT_DEFAULT_LENGTH 2
/**
 * The source port identifier in the TCP header.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_TCP_SOURCE_PORT 182
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_TCP_SOURCE_PORT_DEFAULT_LENGTH 2
/**
 * The destination port identifier in the TCP header.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_TCP_DESTINATION_PORT 183
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_TCP_DESTINATION_PORT_DEFAULT_LENGTH 2
/**
 * The sequence number in the TCP header.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_TCP_SEQUENCE_NUMBER 184
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_TCP_SEQUENCE_NUMBER_DEFAULT_LENGTH 4
/**
 * The acknowledgment number in the TCP header.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_TCP_ACKNOWLEDGMENT_NUMBER 185
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_TCP_ACKNOWLEDGMENT_NUMBER_DEFAULT_LENGTH 4
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_TCP_WINDOW_SIZE 186
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_TCP_WINDOW_SIZE_DEFAULT_LENGTH 2
/**
 * The urgent pointer in the TCP header.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_TCP_URGENT_POINTER 187
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_TCP_URGENT_POINTER_DEFAULT_LENGTH 2
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_TCP_HEADER_LENGTH 188
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_TCP_HEADER_LENGTH_DEFAULT_LENGTH 1
/**
 * The length of the IP header. For IPv6, the value of this Information Element is 40.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IP_HEADER_LENGTH 189
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IP_HEADER_LENGTH_DEFAULT_LENGTH 1
/**
 * The total length of the IPv4 packet.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_TOTAL_LENGTH_IPV4 190
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_TOTAL_LENGTH_IPV4_DEFAULT_LENGTH 2
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_PAYLOAD_LENGTH_IPV6 191
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_PAYLOAD_LENGTH_IPV6_DEFAULT_LENGTH 2
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IP_TTL 192
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IP_TTL_DEFAULT_LENGTH 1
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_NEXT_HEADER_IPV6 193
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_NEXT_HEADER_IPV6_DEFAULT_LENGTH 1
/**
 * The size of the MPLS packet without the label stack.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MPLS_PAYLOAD_LENGTH 194
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MPLS_PAYLOAD_LENGTH_DEFAULT_LENGTH 4
/**
 * The value of a Differentiated Services Code Point (DSCP) encoded in the Differentiated Services
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IP_DIFF_SERV_CODE_POINT 195
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IP_DIFF_SERV_CODE_POINT_DEFAULT_LENGTH 1
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IP_PRECEDENCE 196
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IP_PRECEDENCE_DEFAULT_LENGTH 1
/**
 * Fragmentation properties indicated by flags in the IPv4 packet header or the IPv6 Fragment
 * header, respectively.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_FRAGMENT_FLAGS 197
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_FRAGMENT_FLAGS_DEFAULT_LENGTH 1
/**
 ...
 * payload.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_OCTET_DELTA_SUM_OF_SQUARES 198
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_OCTET_DELTA_SUM_OF_SQUARES_DEFAULT_LENGTH 8
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_OCTET_TOTAL_SUM_OF_SQUARES 199
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_OCTET_TOTAL_SUM_OF_SQUARES_DEFAULT_LENGTH 8
/**
 * The TTL field from the top MPLS label stack entry, i.e., the last label that was pushed.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MPLS_TOP_LABEL_TTL 200
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MPLS_TOP_LABEL_TTL_DEFAULT_LENGTH 1
/**
 * The length of the MPLS label stack in units of octets.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MPLS_LABEL_STACK_LENGTH 201
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MPLS_LABEL_STACK_LENGTH_DEFAULT_LENGTH 4
/**
 * The number of labels in the MPLS label stack.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MPLS_LABEL_STACK_DEPTH 202
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MPLS_LABEL_STACK_DEPTH_DEFAULT_LENGTH 4
/**
 * The Exp field from the top MPLS label stack entry, i.e., the last label that was pushed.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MPLS_TOP_LABEL_EXP 203
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MPLS_TOP_LABEL_EXP_DEFAULT_LENGTH 1
/**
 * The effective length of the IP payload.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IP_PAYLOAD_LENGTH 204
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IP_PAYLOAD_LENGTH_DEFAULT_LENGTH 4
/**
 * The value of the Length field in the UDP header.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_UDP_MESSAGE_LENGTH 205
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_UDP_MESSAGE_LENGTH_DEFAULT_LENGTH 2
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IS_MULTICAST 206
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IS_MULTICAST_DEFAULT_LENGTH 1
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IPV4_IHL 207
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IPV4_IHL_DEFAULT_LENGTH 1
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IPV4_OPTIONS 208
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IPV4_OPTIONS_DEFAULT_LENGTH 4
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_TCP_OPTIONS 209
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_TCP_OPTIONS_DEFAULT_LENGTH 8
/**
 * The value of this Information Element is always a sequence of 0x00 values.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_PADDING_OCTETS 210
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_PADDING_OCTETS_DEFAULT_LENGTH 3
/**
 * An IPv4 address to which the Exporting Process sends Flow information.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_COLLECTOR_IPV4_ADDRESS 211
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_COLLECTOR_IPV4_ADDRESS_DEFAULT_LENGTH 4
/**
 * An IPv6 address to which the Exporting Process sends Flow information.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_COLLECTOR_IPV6_ADDRESS 212
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_COLLECTOR_IPV6_ADDRESS_DEFAULT_LENGTH 8
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_EXPORT_INTERFACE 213
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_EXPORT_INTERFACE_DEFAULT_LENGTH 4
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_EXPORT_PROTOCOL_VERSION 214
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_EXPORT_PROTOCOL_VERSION_DEFAULT_LENGTH 1
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_EXPORT_TRANSPORT_PROTOCOL 215
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_EXPORT_TRANSPORT_PROTOCOL_DEFAULT_LENGTH 1
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_COLLECTOR_TRANSPORT_PORT 216
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_COLLECTOR_TRANSPORT_PORT_DEFAULT_LENGTH 2
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_EXPORTER_TRANSPORT_PORT 217
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_EXPORTER_TRANSPORT_PORT_DEFAULT_LENGTH 2
/**
 * The total number of packets of this Flow with TCP "Synchronize sequence numbers" (SYN) flag set.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_TCP_SYN_TOTAL_COUNT 218
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_TCP_SYN_TOTAL_COUNT_DEFAULT_LENGTH 8
/**
 * The total number of packets of this Flow with TCP "No more data from sender" (FIN) flag set.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_TCP_FIN_TOTAL_COUNT 219
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_TCP_FIN_TOTAL_COUNT_DEFAULT_LENGTH 8
/**
 * The total number of packets of this Flow with TCP "Reset the connection" (RST) flag set.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_TCP_RST_TOTAL_COUNT 220
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_TCP_RST_TOTAL_COUNT_DEFAULT_LENGTH 8
/**
 * The total number of packets of this Flow with TCP "Push Function" (PSH) flag set.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_TCP_PSH_TOTAL_COUNT 221
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_TCP_PSH_TOTAL_COUNT_DEFAULT_LENGTH 8
/**
 * The total number of packets of this Flow with TCP "Acknowledgment field significant" (ACK) flag
 * set.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_TCP_ACK_TOTAL_COUNT 222
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_TCP_ACK_TOTAL_COUNT_DEFAULT_LENGTH 8
/**
 * The total number of packets of this Flow with TCP "Urgent Pointer field significant" (URG) flag
 * set.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_TCP_URG_TOTAL_COUNT 223
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_TCP_URG_TOTAL_COUNT_DEFAULT_LENGTH 8
/**
 * The total length of the IP packet.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IP_TOTAL_LENGTH 224
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IP_TOTAL_LENGTH_DEFAULT_LENGTH 8
/**
 * The definition of this Information Element is identical to the definition of Information Element
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_POST_NAT_SOURCE_IPV4_ADDRESS 225
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_POST_NAT_SOURCE_IPV4_ADDRESS_DEFAULT_LENGTH 4
/**
 * The definition of this Information Element is identical to the definition of Information Element
 * 'destinationIPv4Address', except that it reports a modified value caused by a NAT middlebox
 * function after the packet passed the Observation Point.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_POST_NAT_DESTINATION_IPV4_ADDRESS 226
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_POST_NAT_DESTINATION_IPV4_ADDRESS_DEFAULT_LENGTH 4
/**
 * The definition of this Information Element is identical to the definition of Information Element
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_POST_NAPT_SOURCE_TRANSPORT_PORT 227
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_POST_NAPT_SOURCE_TRANSPORT_PORT_DEFAULT_LENGTH 2
/**
 * The definition of this Information Element is identical to the definition of Information Element
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_POST_NAPT_DESTINATION_TRANSPORT_PORT 228
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_POST_NAPT_DESTINATION_TRANSPORT_PORT_DEFAULT_LENGTH 2
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_NAT_ORIGINATING_ADDRESS_REALM 229
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_NAT_ORIGINATING_ADDRESS_REALM_DEFAULT_LENGTH 1
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_NAT_EVENT 230
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_NAT_EVENT_DEFAULT_LENGTH 1
/**
 ...
 * life of the session.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_INITIATOR_OCTETS 231
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_INITIATOR_OCTETS_DEFAULT_LENGTH 8
/**
 ...
 * the session.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_RESPONDER_OCTETS 232
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_RESPONDER_OCTETS_DEFAULT_LENGTH 8
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_FIREWALL_EVENT 233
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_FIREWALL_EVENT_DEFAULT_LENGTH 1
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_INGRESS_VRFID 234
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_INGRESS_VRFID_DEFAULT_LENGTH 4
/**
 * An unique identifier of the VRFname where the packets of this flow are being sent. This
 * identifier is unique per Metering Process
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_EGRESS_VRFID 235
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_EGRESS_VRFID_DEFAULT_LENGTH 4
/**
 * The name of a VPN Routing and Forwarding table (VRF).
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_VRF_NAME 236
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_VRF_NAME_DEFAULT_LENGTH 64
/**
 * The definition of this Information Element is identical to the definition of Information Element
 * 'mplsTopLabelExp', except that it reports a potentially modified value caused by a middlebox
 * function after the packet passed the Observation Point.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_POST_MPLS_TOP_LABEL_EXP 237
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_POST_MPLS_TOP_LABEL_EXP_DEFAULT_LENGTH 1
/**
 * The scale of the window field in the TCP header.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_TCP_WINDOW_SCALE 238
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_TCP_WINDOW_SCALE_DEFAULT_LENGTH 2
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_BIFLOW_DIRECTION 239
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_BIFLOW_DIRECTION_DEFAULT_LENGTH 1
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_ETHERNET_HEADER_LENGTH 240
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_ETHERNET_HEADER_LENGTH_DEFAULT_LENGTH 1
/**
 * The length of the MAC Client Data section (including any padding) of a frame as defined in
 * section 3.1 of [IEEE.802-3.2005].
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_ETHERNET_PAYLOAD_LENGTH 241
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_ETHERNET_PAYLOAD_LENGTH_DEFAULT_LENGTH 2
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_ETHERNET_TOTAL_LENGTH 242
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_ETHERNET_TOTAL_LENGTH_DEFAULT_LENGTH 2
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DOT1Q_VLAN_ID 243
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DOT1Q_VLAN_ID_DEFAULT_LENGTH 2
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DOT1Q_PRIORITY 244
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DOT1Q_PRIORITY_DEFAULT_LENGTH 1
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DOT1Q_CUSTOMER_VLAN_ID 245
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DOT1Q_CUSTOMER_VLAN_ID_DEFAULT_LENGTH 2
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DOT1Q_CUSTOMER_PRIORITY 246
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DOT1Q_CUSTOMER_PRIORITY_DEFAULT_LENGTH 1
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_METRO_EVC_ID 247
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_METRO_EVC_ID_DEFAULT_LENGTH 64
/**
 * The 3-bit EVC Service Attribute which identifies the type of service provided by an EVC.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_METRO_EVC_TYPE 248
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_METRO_EVC_TYPE_DEFAULT_LENGTH 1
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_PSEUDO_WIRE_ID 249
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_PSEUDO_WIRE_ID_DEFAULT_LENGTH 4
/**
 * The value of this information element identifies the type of MPLS Pseudo Wire (PW) as defined in
 * [RFC4446].
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_PSEUDO_WIRE_TYPE 250
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_PSEUDO_WIRE_TYPE_DEFAULT_LENGTH 2
/**
 * The 32-bit Preferred Pseudo Wire (PW) MPLS Control Word as defined in Section 3 of [RFC4385].
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_PSEUDO_WIRE_CONTROL_WORD 251
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_PSEUDO_WIRE_CONTROL_WORD_DEFAULT_LENGTH 4
/**
 * The index of a networking device's physical interface (example, a switch port) where packets of
 * this flow are being received.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_INGRESS_PHYSICAL_INTERFACE 252
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_INGRESS_PHYSICAL_INTERFACE_DEFAULT_LENGTH 4
/**
 * The index of a networking device's physical interface (example, a switch port) where packets of
 * this flow are being sent.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_EGRESS_PHYSICAL_INTERFACE 253
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_EGRESS_PHYSICAL_INTERFACE_DEFAULT_LENGTH 4
/**
 * The definition of this Information Element is identical to the definition of Information Element
 * 'dot1qVlanId', except that it reports a potentially modified value caused by a middlebox function
 * after the packet passed the Observation Point.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_POST_DOT1Q_VLAN_ID 254
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_POST_DOT1Q_VLAN_ID_DEFAULT_LENGTH 2
/**
 * The definition of this Information Element is identical to the definition of Information Element
 * 'dot1qCustomerVlanId', except that it reports a potentially modified value caused by a middlebox
 * function after the packet passed the Observation Point.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_POST_DOT1Q_CUSTOMER_VLAN_ID 255
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_POST_DOT1Q_CUSTOMER_VLAN_ID_DEFAULT_LENGTH 2
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_ETHERNET_TYPE 256
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_ETHERNET_TYPE_DEFAULT_LENGTH 2
/**
 * The definition of this Information Element is identical to the definition of Information Element
 * 'ipPrecedence', except that it reports a potentially modified value caused by a middlebox
 * function after the packet passed the Observation Point.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_POST_IP_PRECEDENCE 257
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_POST_IP_PRECEDENCE_DEFAULT_LENGTH 1
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_COLLECTION_TIME_MILLISECONDS 258
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_COLLECTION_TIME_MILLISECONDS_DEFAULT_LENGTH 8
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_EXPORT_SCTP_STREAM_ID 259
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_EXPORT_SCTP_STREAM_ID_DEFAULT_LENGTH 2
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MAX_EXPORT_SECONDS 260
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MAX_EXPORT_SECONDS_DEFAULT_LENGTH 4
/**
 ...
 * Information Element.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MAX_FLOW_END_SECONDS 261
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MAX_FLOW_END_SECONDS_DEFAULT_LENGTH 4
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MESSAGE_MD5_CHECKSUM 262
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MESSAGE_MD5_CHECKSUM_DEFAULT_LENGTH 3
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MESSAGE_SCOPE 263
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MESSAGE_SCOPE_DEFAULT_LENGTH 1
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MIN_EXPORT_SECONDS 264
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MIN_EXPORT_SECONDS_DEFAULT_LENGTH 4
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MIN_FLOW_START_SECONDS 265
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MIN_FLOW_START_SECONDS_DEFAULT_LENGTH 4
/**
 ...
 * Element alignment.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_OPAQUE_OCTETS 266
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_OPAQUE_OCTETS_DEFAULT_LENGTH 3
/**
 * The presence of this Information Element as scope in an Options Template signifies that the
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SESSION_SCOPE 267
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SESSION_SCOPE_DEFAULT_LENGTH 1
/**
 * The latest absolute timestamp of the last packet within any Flow within the scope containing this
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MAX_FLOW_END_MICROSECONDS 268
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MAX_FLOW_END_MICROSECONDS_DEFAULT_LENGTH 8
/**
 * The latest absolute timestamp of the last packet within any Flow within the scope containing this
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MAX_FLOW_END_MILLISECONDS 269
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MAX_FLOW_END_MILLISECONDS_DEFAULT_LENGTH 8
/**
 * The latest absolute timestamp of the last packet within any Flow within the scope containing this
 * Information Element. This Information Element SHOULD be bound to its containing IPFIX Transport
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MAX_FLOW_END_NANOSECONDS 270
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MAX_FLOW_END_NANOSECONDS_DEFAULT_LENGTH 8
/**
 * The earliest absolute timestamp of the first packet within any Flow within the scope containing
 ...
 * Elements.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MIN_FLOW_START_MICROSECONDS 271
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MIN_FLOW_START_MICROSECONDS_DEFAULT_LENGTH 8
/**
 * The earliest absolute timestamp of the first packet within any Flow within the scope containing
 ...
 * Elements.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MIN_FLOW_START_MILLISECONDS 272
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MIN_FLOW_START_MILLISECONDS_DEFAULT_LENGTH 8
/**
 * The earliest absolute timestamp of the first packet within any Flow within the scope containing
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MIN_FLOW_START_NANOSECONDS 273
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MIN_FLOW_START_NANOSECONDS_DEFAULT_LENGTH 8
/**
 ...
 * Information Element.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_COLLECTOR_CERTIFICATE 274
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_COLLECTOR_CERTIFICATE_DEFAULT_LENGTH 3
/**
 * The full X.509 certificate, encoded in ASN.1 DER format, used by the Collector when IPFIX
 * Messages were transmitted using TLS or DTLS. This Information Element SHOULD be bound to its
 * containing IPFIX Transport Session via an options record and the sessionScope Information
 ...
 * Information Element.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_EXPORTER_CERTIFICATE 275
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_EXPORTER_CERTIFICATE_DEFAULT_LENGTH 3
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DATA_RECORDS_RELIABILITY 276
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DATA_RECORDS_RELIABILITY_DEFAULT_LENGTH 1
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_OBSERVATION_POINT_TYPE 277
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_OBSERVATION_POINT_TYPE_DEFAULT_LENGTH 1
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_NEW_CONNECTION_DELTA_COUNT 278
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_NEW_CONNECTION_DELTA_COUNT_DEFAULT_LENGTH 4
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_CONNECTION_SUM_DURATION_SECONDS 279
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_CONNECTION_SUM_DURATION_SECONDS_DEFAULT_LENGTH 8
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_CONNECTION_TRANSACTION_ID 280
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_CONNECTION_TRANSACTION_ID_DEFAULT_LENGTH 8
/**
 * The definition of this Information Element is identical to the definition of Information Element
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_POST_NATSOURCE_IPV6_ADDRESS 281
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_POST_NATSOURCE_IPV6_ADDRESS_DEFAULT_LENGTH 8
/**
 * The definition of this Information Element is identical to the definition of Information Element
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_POST_NATDESTINATION_IPV6_ADDRESS 282
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_POST_NATDESTINATION_IPV6_ADDRESS_DEFAULT_LENGTH 8
/**
 * Locally unique identifier of a NAT pool.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_NAT_POOL_ID 283
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_NAT_POOL_ID_DEFAULT_LENGTH 4
/**
 * The name of a NAT pool identified by a natPoolID.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_NAT_POOL_NAME 284
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_NAT_POOL_NAME_DEFAULT_LENGTH 64
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_ANONYMIZATION_FLAGS 285
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_ANONYMIZATION_FLAGS_DEFAULT_LENGTH 2
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_ANONYMIZATION_TECHNIQUE 286
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_ANONYMIZATION_TECHNIQUE_DEFAULT_LENGTH 2
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_INFORMATION_ELEMENT_INDEX 287
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_INFORMATION_ELEMENT_INDEX_DEFAULT_LENGTH 2
/**
 * Specifies if the Application ID is based on peer-to-peer technology.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_P2P_TECHNOLOGY 288
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_P2P_TECHNOLOGY_DEFAULT_LENGTH 64
/**
 * Specifies if the Application ID is used as a tunnel technology.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_TUNNEL_TECHNOLOGY 289
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_TUNNEL_TECHNOLOGY_DEFAULT_LENGTH 64
/**
 * Specifies if the Application ID is an encrypted networking protocol.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_ENCRYPTED_TECHNOLOGY 290
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_ENCRYPTED_TECHNOLOGY_DEFAULT_LENGTH 64
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_BASIC_LIST 291
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_BASIC_LIST_DEFAULT_LENGTH 64
/**
 * Specifies a generic Information Element with a subTemplateList abstract data type.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SUB_TEMPLATE_LIST 292
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SUB_TEMPLATE_LIST_DEFAULT_LENGTH 64
/**
 * Specifies a generic Information Element with a subTemplateMultiList abstract data type.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SUB_TEMPLATE_MULTI_LIST 293
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SUB_TEMPLATE_MULTI_LIST_DEFAULT_LENGTH 64
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_BGP_VALIDITY_STATE 294
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_BGP_VALIDITY_STATE_DEFAULT_LENGTH 1
/**
 * IPSec Security Parameters Index (SPI).
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IPSEC_SPI 295
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IPSEC_SPI_DEFAULT_LENGTH 4
/**
 * GRE key, which is used for identifying an individual traffic flow within a tunnel.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_GRE_KEY 296
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_GRE_KEY_DEFAULT_LENGTH 4
/**
 * Values are listed in the natType registry. See
 * [http://www.iana.org/assignments/ipfix/ipfix.xhtml#ipfix-nat-type].
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_NAT_TYPE 297
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_NAT_TYPE_DEFAULT_LENGTH 1
/**
 ...
 * of the session.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_INITIATOR_PACKETS 298
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_INITIATOR_PACKETS_DEFAULT_LENGTH 8
/**
 ...
 * session.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_RESPONDER_PACKETS 299
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_RESPONDER_PACKETS_DEFAULT_LENGTH 8
/**
 * The name of an observation domain identified by an observationDomainId.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_OBSERVATION_DOMAIN_NAME 300
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_OBSERVATION_DOMAIN_NAME_DEFAULT_LENGTH 64
/**
 ...
 * are selected.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SELECTION_SEQUENCE_ID 301
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SELECTION_SEQUENCE_ID_DEFAULT_LENGTH 8
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SELECTOR_ID 302
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SELECTOR_ID_DEFAULT_LENGTH 8
/**
 * This Information Element contains the ID of another Information Element.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_INFORMATION_ELEMENT_ID 303
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_INFORMATION_ELEMENT_ID_DEFAULT_LENGTH 2
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SELECTOR_ALGORITHM 304
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SELECTOR_ALGORITHM_DEFAULT_LENGTH 2
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SAMPLING_PACKET_INTERVAL 305
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SAMPLING_PACKET_INTERVAL_DEFAULT_LENGTH 4
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SAMPLING_PACKET_SPACE 306
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SAMPLING_PACKET_SPACE_DEFAULT_LENGTH 4
/**
 * This Information Element specifies the time interval in microseconds during which all arriving
 * packets are sampled.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SAMPLING_TIME_INTERVAL 307
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SAMPLING_TIME_INTERVAL_DEFAULT_LENGTH 4
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SAMPLING_TIME_SPACE 308
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SAMPLING_TIME_SPACE_DEFAULT_LENGTH 4
/**
 * This Information Element specifies the number of elements taken from the parent Population for
 * random Sampling methods.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SAMPLING_SIZE 309
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SAMPLING_SIZE_DEFAULT_LENGTH 4
/**
 * This Information Element specifies the number of elements in the parent Population for random
 * Sampling methods.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SAMPLING_POPULATION 310
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SAMPLING_POPULATION_DEFAULT_LENGTH 4
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SAMPLING_PROBABILITY 311
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SAMPLING_PROBABILITY_DEFAULT_LENGTH 8
/**
 * This Information Element specifies the length of the selected data link frame.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DATA_LINK_FRAME_SIZE 312
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DATA_LINK_FRAME_SIZE_DEFAULT_LENGTH 2
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IP_HEADER_PACKET_SECTION 313
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IP_HEADER_PACKET_SECTION_DEFAULT_LENGTH 3
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IP_PAYLOAD_PACKET_SECTION 314
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IP_PAYLOAD_PACKET_SECTION_DEFAULT_LENGTH 3
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DATA_LINK_FRAME_SECTION 315
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DATA_LINK_FRAME_SECTION_DEFAULT_LENGTH 3
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MPLS_LABEL_STACK_SECTION 316
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MPLS_LABEL_STACK_SECTION_DEFAULT_LENGTH 3
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MPLS_PAYLOAD_PACKET_SECTION 317
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MPLS_PAYLOAD_PACKET_SECTION_DEFAULT_LENGTH 3
/**
 * This Information Element specifies the total number of packets observed by a Selector, for a
 * specific value of SelectorId.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SELECTOR_ID_TOTAL_PKTS_OBSERVED 318
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SELECTOR_ID_TOTAL_PKTS_OBSERVED_DEFAULT_LENGTH 8
/**
 * This Information Element specifies the total number of packets selected by a Selector, for a
 * specific value of SelectorId.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SELECTOR_ID_TOTAL_PKTS_SELECTED 319
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SELECTOR_ID_TOTAL_PKTS_SELECTED_DEFAULT_LENGTH 8
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_ABSOLUTE_ERROR 320
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_ABSOLUTE_ERROR_DEFAULT_LENGTH 8
/**
 ...
 * value.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_RELATIVE_ERROR 321
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_RELATIVE_ERROR_DEFAULT_LENGTH 8
/**
 * This Information Element specifies the absolute time in seconds of an observation.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_OBSERVATION_TIME_SECONDS 322
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_OBSERVATION_TIME_SECONDS_DEFAULT_LENGTH 4
/**
 * This Information Element specifies the absolute time in milliseconds of an observation.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_OBSERVATION_TIME_MILLISECONDS 323
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_OBSERVATION_TIME_MILLISECONDS_DEFAULT_LENGTH 8
/**
 * This Information Element specifies the absolute time in microseconds of an observation.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_OBSERVATION_TIME_MICROSECONDS 324
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_OBSERVATION_TIME_MICROSECONDS_DEFAULT_LENGTH 8
/**
 * This Information Element specifies the absolute time in nanoseconds of an observation.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_OBSERVATION_TIME_NANOSECONDS 325
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_OBSERVATION_TIME_NANOSECONDS_DEFAULT_LENGTH 8
/**
 * This Information Element specifies the value from the digest hash function. See also
 * Sections 6.2, 3.8 and 7.1 of [RFC5475].
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DIGEST_HASH_VALUE 326
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DIGEST_HASH_VALUE_DEFAULT_LENGTH 8
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_HASH_IPPAYLOAD_OFFSET 327
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_HASH_IPPAYLOAD_OFFSET_DEFAULT_LENGTH 8
/**
 * This Information Element specifies the IP payload size used by a Hash-based Selection Selector.
 * See also Sections 6.2, 3.8 and 7.1 of [RFC5475].
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_HASH_IPPAYLOAD_SIZE 328
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_HASH_IPPAYLOAD_SIZE_DEFAULT_LENGTH 8
/**
 * This Information Element specifies the value for the beginning of a hash function's potential
 * output range.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_HASH_OUTPUT_RANGE_MIN 329
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_HASH_OUTPUT_RANGE_MIN_DEFAULT_LENGTH 8
/**
 * This Information Element specifies the value for the end of a hash function's potential output
 * range.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_HASH_OUTPUT_RANGE_MAX 330
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_HASH_OUTPUT_RANGE_MAX_DEFAULT_LENGTH 8
/**
 * This Information Element specifies the value for the beginning of a hash function's selected
 * range.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_HASH_SELECTED_RANGE_MIN 331
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_HASH_SELECTED_RANGE_MIN_DEFAULT_LENGTH 8
/**
 * This Information Element specifies the value for the end of a hash function's selected range.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_HASH_SELECTED_RANGE_MAX 332
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_HASH_SELECTED_RANGE_MAX_DEFAULT_LENGTH 8
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_HASH_DIGEST_OUTPUT 333
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_HASH_DIGEST_OUTPUT_DEFAULT_LENGTH 1
/**
 * This Information Element specifies the initializer value to the hash function.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_HASH_INITIALIZER_VALUE 334
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_HASH_INITIALIZER_VALUE_DEFAULT_LENGTH 8
/**
 * The name of a selector identified by a selectorID. Globally unique per Metering Process.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SELECTOR_NAME 335
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SELECTOR_NAME_DEFAULT_LENGTH 64
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_UPPER_CILIMIT 336
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_UPPER_CILIMIT_DEFAULT_LENGTH 8
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_LOWER_CILIMIT 337
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_LOWER_CILIMIT_DEFAULT_LENGTH 8
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_CONFIDENCE_LEVEL 338
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_CONFIDENCE_LEVEL_DEFAULT_LENGTH 8
/**
 ...
 * subregistry.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_INFORMATION_ELEMENT_DATA_TYPE 339
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_INFORMATION_ELEMENT_DATA_TYPE_DEFAULT_LENGTH 1
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_INFORMATION_ELEMENT_DESCRIPTION 340
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_INFORMATION_ELEMENT_DESCRIPTION_DEFAULT_LENGTH 64
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_INFORMATION_ELEMENT_NAME 341
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_INFORMATION_ELEMENT_NAME_DEFAULT_LENGTH 64
/**
 * Contains the inclusive low end of the range of acceptable values for an Information Element.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_INFORMATION_ELEMENT_RANGE_BEGIN 342
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_INFORMATION_ELEMENT_RANGE_BEGIN_DEFAULT_LENGTH 8
/**
 * Contains the inclusive high end of the range of acceptable values for an Information Element.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_INFORMATION_ELEMENT_RANGE_END 343
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_INFORMATION_ELEMENT_RANGE_END_DEFAULT_LENGTH 8
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_INFORMATION_ELEMENT_SEMANTICS 344
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_INFORMATION_ELEMENT_SEMANTICS_DEFAULT_LENGTH 1
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_INFORMATION_ELEMENT_UNITS 345
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_INFORMATION_ELEMENT_UNITS_DEFAULT_LENGTH 2
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_PRIVATE_ENTERPRISE_NUMBER 346
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_PRIVATE_ENTERPRISE_NUMBER_DEFAULT_LENGTH 4
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_VIRTUAL_STATION_INTERFACE_ID 347
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_VIRTUAL_STATION_INTERFACE_ID_DEFAULT_LENGTH 3
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_VIRTUAL_STATION_INTERFACE_NAME 348
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_VIRTUAL_STATION_INTERFACE_NAME_DEFAULT_LENGTH 64
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_VIRTUAL_STATION_UUID 349
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_VIRTUAL_STATION_UUID_DEFAULT_LENGTH 3
/**
 * Name of a Virtual Station. A Virtual Station is an end station instance: it can be a virtual
 * machine or a physical host.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_VIRTUAL_STATION_NAME 350
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_VIRTUAL_STATION_NAME_DEFAULT_LENGTH 64
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_LAYER2_SEGMENT_ID 351
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_LAYER2_SEGMENT_ID_DEFAULT_LENGTH 8
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_LAYER2_OCTET_DELTA_COUNT 352
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_LAYER2_OCTET_DELTA_COUNT_DEFAULT_LENGTH 8
/**
 ...
 * #85)
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_LAYER2_OCTET_TOTAL_COUNT 353
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_LAYER2_OCTET_TOTAL_COUNT_DEFAULT_LENGTH 8
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_INGRESS_UNICAST_PACKET_TOTAL_COUNT 354
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_INGRESS_UNICAST_PACKET_TOTAL_COUNT_DEFAULT_LENGTH 8
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_INGRESS_MULTICAST_PACKET_TOTAL_COUNT 355
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_INGRESS_MULTICAST_PACKET_TOTAL_COUNT_DEFAULT_LENGTH 8
/**
 * The total number of incoming broadcast packets metered at the Observation Point since the
 * Metering Process (re-)initialization for this Observation Point.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_INGRESS_BROADCAST_PACKET_TOTAL_COUNT 356
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_INGRESS_BROADCAST_PACKET_TOTAL_COUNT_DEFAULT_LENGTH 8
/**
 * The total number of incoming unicast packets metered at the Observation Point since the Metering
 * Process (re-)initialization for this Observation Point.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_EGRESS_UNICAST_PACKET_TOTAL_COUNT 357
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_EGRESS_UNICAST_PACKET_TOTAL_COUNT_DEFAULT_LENGTH 8
/**
 * The total number of incoming broadcast packets metered at the Observation Point since the
 * Metering Process (re-)initialization for this Observation Point.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_EGRESS_BROADCAST_PACKET_TOTAL_COUNT 358
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_EGRESS_BROADCAST_PACKET_TOTAL_COUNT_DEFAULT_LENGTH 8
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MONITORING_INTERVAL_START_MILLI_SECONDS 359
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MONITORING_INTERVAL_START_MILLI_SECONDS_DEFAULT_LENGTH 8
/**
 * The absolute timestamp at which the monitoring interval ended. A Monitoring interval is the
 * period of time during which the Metering Process is running.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MONITORING_INTERVAL_END_MILLI_SECONDS 360
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MONITORING_INTERVAL_END_MILLI_SECONDS_DEFAULT_LENGTH 8
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_PORT_RANGE_START 361
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_PORT_RANGE_START_DEFAULT_LENGTH 2
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_PORT_RANGE_END 362
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_PORT_RANGE_END_DEFAULT_LENGTH 2
/**
 ...
 * other way.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_PORT_RANGE_STEP_SIZE 363
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_PORT_RANGE_STEP_SIZE_DEFAULT_LENGTH 2
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_PORT_RANGE_NUM_PORTS 364
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_PORT_RANGE_NUM_PORTS_DEFAULT_LENGTH 2
/**
 * The IEEE 802 MAC address of a wireless station (STA).
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_STA_MAC_ADDRESS 365
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_STA_MAC_ADDRESS_DEFAULT_LENGTH 6
/**
 * The IPv4 address of a wireless station (STA).
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_STA_IPV4_ADDRESS 366
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_STA_IPV4_ADDRESS_DEFAULT_LENGTH 4
/**
 * The IEEE 802 MAC address of a wireless access point (WTP).
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_WTP_MAC_ADDRESS 367
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_WTP_MAC_ADDRESS_DEFAULT_LENGTH 6
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_INGRESS_INTERFACE_TYPE 368
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_INGRESS_INTERFACE_TYPE_DEFAULT_LENGTH 4
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_EGRESS_INTERFACE_TYPE 369
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_EGRESS_INTERFACE_TYPE_DEFAULT_LENGTH 4
/**
 * The RTP sequence number per [RFC3550].
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_RTP_SEQUENCE_NUMBER 370
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_RTP_SEQUENCE_NUMBER_DEFAULT_LENGTH 2
/**
 * User name associated with the flow.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_USER_NAME 371
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_USER_NAME_DEFAULT_LENGTH 64
/**
 * An attribute that provides a first level categorization for each Application ID.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_APPLICATION_CATEGORY_NAME 372
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_APPLICATION_CATEGORY_NAME_DEFAULT_LENGTH 64
/**
 * An attribute that provides a second level categorization for each Application ID.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_APPLICATION_SUB_CATEGORY_NAME 373
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_APPLICATION_SUB_CATEGORY_NAME_DEFAULT_LENGTH 64
/**
 * An attribute that groups multiple Application IDs that belong to the same networking application.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_APPLICATION_GROUP_NAME 374
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_APPLICATION_GROUP_NAME_DEFAULT_LENGTH 64
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_ORIGINAL_FLOWS_PRESENT 375
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_ORIGINAL_FLOWS_PRESENT_DEFAULT_LENGTH 8
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_ORIGINAL_FLOWS_INITIATED 376
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_ORIGINAL_FLOWS_INITIATED_DEFAULT_LENGTH 8
/**
 * The conservative count of Original Flows whose last packet is represented within this Aggregated
 * Flow. Conservative counts must sum to the original count on re-aggregation.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_ORIGINAL_FLOWS_COMPLETED 377
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_ORIGINAL_FLOWS_COMPLETED_DEFAULT_LENGTH 8
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DISTINCT_COUNT_OF_SOURCE_IP_ADDRESS 378
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DISTINCT_COUNT_OF_SOURCE_IP_ADDRESS_DEFAULT_LENGTH 8
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DISTINCT_COUNT_OF_DESTINATION_IP_ADDRESS 379
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DISTINCT_COUNT_OF_DESTINATION_IP_ADDRESS_DEFAULT_LENGTH 8
/**
 * The count of distinct source IPv4 address values for Original Flows contributing to this
 * Aggregated Flow.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DISTINCT_COUNT_OF_SOURCE_IPV4_ADDRESS 380
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DISTINCT_COUNT_OF_SOURCE_IPV4_ADDRESS_DEFAULT_LENGTH 4
/**
 * The count of distinct destination IPv4 address values for Original Flows contributing to this
 * Aggregated Flow.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DISTINCT_COUNT_OF_DESTINATION_IPV4_ADDRESS 381
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DISTINCT_COUNT_OF_DESTINATION_IPV4_ADDRESS_DEFAULT_LENGTH 4
/**
 * The count of distinct source IPv6 address values for Original Flows contributing to this
 * Aggregated Flow.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DISTINCT_COUNT_OF_SOURCE_IPV6_ADDRESS 382
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DISTINCT_COUNT_OF_SOURCE_IPV6_ADDRESS_DEFAULT_LENGTH 8
/**
 * The count of distinct destination IPv6 address values for Original Flows contributing to this
 * Aggregated Flow.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DISTINCT_COUNT_OF_DESTINATION_IPV6_ADDRESS 383
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DISTINCT_COUNT_OF_DESTINATION_IPV6_ADDRESS_DEFAULT_LENGTH 8
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_VALUE_DISTRIBUTION_METHOD 384
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_VALUE_DISTRIBUTION_METHOD_DEFAULT_LENGTH 1
/**
 * Interarrival jitter as defined in section 6.4.1 of [RFC3550], measured in milliseconds.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_RFC3550_JITTER_MILLISECONDS 385
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_RFC3550_JITTER_MILLISECONDS_DEFAULT_LENGTH 4
/**
 * Interarrival jitter as defined in section 6.4.1 of [RFC3550], measured in microseconds.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_RFC3550_JITTER_MICROSECONDS 386
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_RFC3550_JITTER_MICROSECONDS_DEFAULT_LENGTH 4
/**
 * Interarrival jitter as defined in section 6.4.1 of [RFC3550], measured in nanoseconds.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_RFC3550_JITTER_NANOSECONDS 387
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_RFC3550_JITTER_NANOSECONDS_DEFAULT_LENGTH 4
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DOT1Q_DEI 388
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DOT1Q_DEI_DEFAULT_LENGTH 1
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DOT1Q_CUSTOMER_DEI 389
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DOT1Q_CUSTOMER_DEI_DEFAULT_LENGTH 1
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_FLOW_SELECTOR_ALGORITHM 390
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_FLOW_SELECTOR_ALGORITHM_DEFAULT_LENGTH 2
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_FLOW_SELECTED_OCTET_DELTA_COUNT 391
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_FLOW_SELECTED_OCTET_DELTA_COUNT_DEFAULT_LENGTH 8
/**
 * This Information Element specifies the volume in packets of all Flows that were selected in the
 * Intermediate Flow Selection Process since the previous report.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_FLOW_SELECTED_PACKET_DELTA_COUNT 392
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_FLOW_SELECTED_PACKET_DELTA_COUNT_DEFAULT_LENGTH 8
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_FLOW_SELECTED_FLOW_DELTA_COUNT 393
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_FLOW_SELECTED_FLOW_DELTA_COUNT_DEFAULT_LENGTH 8
/**
 ...
 * [RFC7011].
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SELECTOR_ID_TOTAL_FLOWS_OBSERVED 394
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SELECTOR_ID_TOTAL_FLOWS_OBSERVED_DEFAULT_LENGTH 8
/**
 ...
 * [RFC7011].
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SELECTOR_ID_TOTAL_FLOWS_SELECTED 395
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SELECTOR_ID_TOTAL_FLOWS_SELECTED_DEFAULT_LENGTH 8
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SAMPLING_FLOW_INTERVAL 396
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SAMPLING_FLOW_INTERVAL_DEFAULT_LENGTH 8
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SAMPLING_FLOW_SPACING 397
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SAMPLING_FLOW_SPACING_DEFAULT_LENGTH 8
/**
 * This Information Element specifies the time interval in microseconds during which all arriving
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_FLOW_SAMPLING_TIME_INTERVAL 398
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_FLOW_SAMPLING_TIME_INTERVAL_DEFAULT_LENGTH 8
/**
 * This Information Element specifies the time interval in microseconds between two
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_FLOW_SAMPLING_TIME_SPACING 399
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_FLOW_SAMPLING_TIME_SPACING_DEFAULT_LENGTH 8
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_HASH_FLOW_DOMAIN 400
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_HASH_FLOW_DOMAIN_DEFAULT_LENGTH 2
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_TRANSPORT_OCTET_DELTA_COUNT 401
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_TRANSPORT_OCTET_DELTA_COUNT_DEFAULT_LENGTH 8
/**
 ...
 * any).
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_TRANSPORT_PACKET_DELTA_COUNT 402
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_TRANSPORT_PACKET_DELTA_COUNT_DEFAULT_LENGTH 8
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_ORIGINAL_EXPORTER_IPV4_ADDRESS 403
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_ORIGINAL_EXPORTER_IPV4_ADDRESS_DEFAULT_LENGTH 4
/**
 * The IPv6 address used by the Exporting Process on an Original Exporter, as seen by the Collecting
 * Process on an IPFIX Mediator. Used to provide information about the Original Observation Points
 * to a downstream Collector.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_ORIGINAL_EXPORTER_IPV6_ADDRESS 404
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_ORIGINAL_EXPORTER_IPV6_ADDRESS_DEFAULT_LENGTH 8
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_ORIGINAL_OBSERVATION_DOMAIN_ID 405
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_ORIGINAL_OBSERVATION_DOMAIN_ID_DEFAULT_LENGTH 4
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_INTERMEDIATE_PROCESS_ID 406
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_INTERMEDIATE_PROCESS_ID_DEFAULT_LENGTH 4
/**
 ...
 * Process.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IGNORED_DATA_RECORD_TOTAL_COUNT 407
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IGNORED_DATA_RECORD_TOTAL_COUNT_DEFAULT_LENGTH 8
/**
 * This Information Element specifies the type of the selected data link frame.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DATA_LINK_FRAME_TYPE 408
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DATA_LINK_FRAME_TYPE_DEFAULT_LENGTH 2
/**
 ...
 * offset).
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SECTION_OFFSET 409
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SECTION_OFFSET_DEFAULT_LENGTH 2
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SECTION_EXPORTED_OCTETS 410
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SECTION_EXPORTED_OCTETS_DEFAULT_LENGTH 2
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DOT1Q_SERVICE_INSTANCE_TAG 411
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DOT1Q_SERVICE_INSTANCE_TAG_DEFAULT_LENGTH 3
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DOT1Q_SERVICE_INSTANCE_ID 412
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DOT1Q_SERVICE_INSTANCE_ID_DEFAULT_LENGTH 4
/**
 ...
 * described in [IEEE802.1Q].
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DOT1Q_SERVICE_INSTANCE_PRIORITY 413
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DOT1Q_SERVICE_INSTANCE_PRIORITY_DEFAULT_LENGTH 1
/**
 ...
 * [IEEE802.1Q].
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DOT1Q_CUSTOMER_SOURCE_MAC_ADDRESS 414
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DOT1Q_CUSTOMER_SOURCE_MAC_ADDRESS_DEFAULT_LENGTH 6
/**
 * The value of the Encapsulated Customer Destination Address (C-DA) portion of the Backbone Service
 * Instance Tag (I-TAG) Tag Control Information (TCI) field of an Ethernet frame as described in
 * [IEEE802.1Q].
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DOT1Q_CUSTOMER_DESTINATION_MAC_ADDRESS 415
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DOT1Q_CUSTOMER_DESTINATION_MAC_ADDRESS_DEFAULT_LENGTH 6
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_POST_LAYER2_OCTET_DELTA_COUNT 417
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_POST_LAYER2_OCTET_DELTA_COUNT_DEFAULT_LENGTH 8
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_POST_MCAST_LAYER2_OCTET_DELTA_COUNT 418
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_POST_MCAST_LAYER2_OCTET_DELTA_COUNT_DEFAULT_LENGTH 8
/**
 * The definition of this Information Element is identical to the definition of the
 * layer2OctetTotalCount Information Element, except that it reports a potentially modified value
 * caused by a middlebox function after the packet passed the Observation Point.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_POST_LAYER2_OCTET_TOTAL_COUNT 420
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_POST_LAYER2_OCTET_TOTAL_COUNT_DEFAULT_LENGTH 8
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_POST_MCAST_LAYER2_OCTET_TOTAL_COUNT 421
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_POST_MCAST_LAYER2_OCTET_TOTAL_COUNT_DEFAULT_LENGTH 8
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MIN_LAYER2_TOTAL_LENGTH 422
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MIN_LAYER2_TOTAL_LENGTH_DEFAULT_LENGTH 8
/**
 * Layer 2 length of the largest packet observed for this Flow. The packet length includes the
 * length of the layer 2 header(s) and the length of the layer 2 payload.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MAX_LAYER2_TOTAL_LENGTH 423
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MAX_LAYER2_TOTAL_LENGTH_DEFAULT_LENGTH 8
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DROPPED_LAYER2_OCTET_DELTA_COUNT 424
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DROPPED_LAYER2_OCTET_DELTA_COUNT_DEFAULT_LENGTH 8
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DROPPED_LAYER2_OCTET_TOTAL_COUNT 425
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_DROPPED_LAYER2_OCTET_TOTAL_COUNT_DEFAULT_LENGTH 8
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IGNORED_LAYER2_OCTET_TOTAL_COUNT 426
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IGNORED_LAYER2_OCTET_TOTAL_COUNT_DEFAULT_LENGTH 8
/**
 * The total number of octets in observed layer 2 packets (including the layer 2 header) that the
 * Metering Process did not process since the (re-)initialization of the Metering Process.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_NOT_SENT_LAYER2_OCTET_TOTAL_COUNT 427
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_NOT_SENT_LAYER2_OCTET_TOTAL_COUNT_DEFAULT_LENGTH 8
/**
 ...
 * and layer 2 payload.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_LAYER2_OCTET_DELTA_SUM_OF_SQUARES 428
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_LAYER2_OCTET_DELTA_SUM_OF_SQUARES_DEFAULT_LENGTH 8
/**
 * The total sum of the squared numbers of layer 2 octets in incoming packets for this Flow at the
 * Observation Point since the Metering Process (re-)initialization for this Observation Point. The
 * number of octets includes layer 2 header(s) and layer 2 payload.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_LAYER2_OCTET_TOTAL_SUM_OF_SQUARES 429
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_LAYER2_OCTET_TOTAL_SUM_OF_SQUARES_DEFAULT_LENGTH 8
/**
 * The number of incoming layer 2 frames since the previous report (if any) for this Flow at the
 * Observation Point.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_LAYER2_FRAME_DELTA_COUNT 430
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_LAYER2_FRAME_DELTA_COUNT_DEFAULT_LENGTH 8
/**
 * The total number of incoming layer 2 frames for this Flow at the Observation Point since the
 * Metering Process (re-)initialization for this Observation Point.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_LAYER2_FRAME_TOTAL_COUNT 431
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_LAYER2_FRAME_TOTAL_COUNT_DEFAULT_LENGTH 8
/**
 * The destination IPv4 address of the PSN tunnel carrying the pseudowire.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_PSEUDO_WIRE_DESTINATION_IPV4_ADDRESS 432
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_PSEUDO_WIRE_DESTINATION_IPV4_ADDRESS_DEFAULT_LENGTH 4
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IGNORED_LAYER2_FRAME_TOTAL_COUNT 433
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_IGNORED_LAYER2_FRAME_TOTAL_COUNT_DEFAULT_LENGTH 8
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MIB_OBJECT_VALUE_INTEGER 434
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MIB_OBJECT_VALUE_INTEGER_DEFAULT_LENGTH 4
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MIB_OBJECT_VALUE_OCTET_STRING 435
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MIB_OBJECT_VALUE_OCTET_STRING_DEFAULT_LENGTH 3
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MIB_OBJECT_VALUE_OID 436
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MIB_OBJECT_VALUE_OID_DEFAULT_LENGTH 3
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MIB_OBJECT_VALUE_BITS 437
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MIB_OBJECT_VALUE_BITS_DEFAULT_LENGTH 3
/**
 ...
 * ipv4Address.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MIB_OBJECT_VALUE_IPADDRESS 438
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MIB_OBJECT_VALUE_IPADDRESS_DEFAULT_LENGTH 4
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MIB_OBJECT_VALUE_COUNTER 439
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MIB_OBJECT_VALUE_COUNTER_DEFAULT_LENGTH 8
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MIB_OBJECT_VALUE_GAUGE 440
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MIB_OBJECT_VALUE_GAUGE_DEFAULT_LENGTH 4
/**
 ...
 * unsigned32.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MIB_OBJECT_VALUE_TIME_TICKS 441
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MIB_OBJECT_VALUE_TIME_TICKS_DEFAULT_LENGTH 4
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MIB_OBJECT_VALUE_UNSIGNED 442
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MIB_OBJECT_VALUE_UNSIGNED_DEFAULT_LENGTH 4
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MIB_OBJECT_VALUE_TABLE 443
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MIB_OBJECT_VALUE_TABLE_DEFAULT_LENGTH 64
/**
 ...
 * include all the objects listed in the INDEX clause as Scope Fields.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MIB_OBJECT_VALUE_ROW 444
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MIB_OBJECT_VALUE_ROW_DEFAULT_LENGTH 64
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MIB_OBJECT_IDENTIFIER 445
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MIB_OBJECT_IDENTIFIER_DEFAULT_LENGTH 3
/**
 * A non-negative sub-identifier of an Object Identifier (OID).
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MIB_SUB_IDENTIFIER 446
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MIB_SUB_IDENTIFIER_DEFAULT_LENGTH 4
/**
 ...
 * case.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MIB_INDEX_INDICATOR 447
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MIB_INDEX_INDICATOR_DEFAULT_LENGTH 8
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MIB_CAPTURE_TIME_SEMANTICS 448
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MIB_CAPTURE_TIME_SEMANTICS_DEFAULT_LENGTH 1
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MIB_CONTEXT_ENGINE_ID 449
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MIB_CONTEXT_ENGINE_ID_DEFAULT_LENGTH 3
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MIB_CONTEXT_NAME 450
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MIB_CONTEXT_NAME_DEFAULT_LENGTH 64
/**
 * The name (called a descriptor in [RFC2578] of an object type definition.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MIB_OBJECT_NAME 451
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MIB_OBJECT_NAME_DEFAULT_LENGTH 64
/**
 * The value of the DESCRIPTION clause of a MIB object type definition.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MIB_OBJECT_DESCRIPTION 452
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MIB_OBJECT_DESCRIPTION_DEFAULT_LENGTH 64
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MIB_OBJECT_SYNTAX 453
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MIB_OBJECT_SYNTAX_DEFAULT_LENGTH 64
/**
 * The textual name of the MIB module that defines a MIB object.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MIB_MODULE_NAME 454
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MIB_MODULE_NAME_DEFAULT_LENGTH 64
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MOBILE_IMSI 455
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MOBILE_IMSI_DEFAULT_LENGTH 64
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MOBILE_MSISDN 456
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MOBILE_MSISDN_DEFAULT_LENGTH 64
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_HTTP_STATUS_CODE 457
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_HTTP_STATUS_CODE_DEFAULT_LENGTH 2
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SOURCE_TRANSPORT_PORTS_LIMIT 458
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_SOURCE_TRANSPORT_PORTS_LIMIT_DEFAULT_LENGTH 2
/**
 * The HTTP request method, as defined in section 4 of [RFC7231], associated with a flow. String
 * with up to 8 UTF-8 characters.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_HTTP_REQUEST_METHOD 459
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_HTTP_REQUEST_METHOD_DEFAULT_LENGTH 64
/**
 ...
 * in UTF-8.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_HTTP_REQUEST_HOST 460
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_HTTP_REQUEST_HOST_DEFAULT_LENGTH 64
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_HTTP_REQUEST_TARGET 461
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_HTTP_REQUEST_TARGET_DEFAULT_LENGTH 64
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_HTTP_MESSAGE_VERSION 462
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_HTTP_MESSAGE_VERSION_DEFAULT_LENGTH 64
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_NAT_INSTANCE_ID 463
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_NAT_INSTANCE_ID_DEFAULT_LENGTH 4
/**
 ...
 * same.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_INTERNAL_ADDRESS_REALM 464
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_INTERNAL_ADDRESS_REALM_DEFAULT_LENGTH 3
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_EXTERNAL_ADDRESS_REALM 465
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_EXTERNAL_ADDRESS_REALM_DEFAULT_LENGTH 3
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_NAT_QUOTA_EXCEEDED_EVENT 466
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_NAT_QUOTA_EXCEEDED_EVENT_DEFAULT_LENGTH 4
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_NAT_THRESHOLD_EVENT 467
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_NAT_THRESHOLD_EVENT_DEFAULT_LENGTH 4
/**
 * The HTTP User-Agent header field as defined in section 5.5.3 of [RFC7231]. Encoded in UTF-8.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_HTTP_USER_AGENT 468
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_HTTP_USER_AGENT_DEFAULT_LENGTH 64
/**
 * The HTTP Content-Type header field as defined in section 3.1.1.5 of [RFC7231]. Encoded in UTF-8.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_HTTP_CONTENT_TYPE 469
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_HTTP_CONTENT_TYPE_DEFAULT_LENGTH 64
/**
 * The HTTP reason phrase as defined in section 6.1 of [RFC7231].
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_HTTP_REASON_PHRASE 470
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_HTTP_REASON_PHRASE_DEFAULT_LENGTH 64
/**
 * This element represents the maximum session entries that can be created by the NAT device.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MAX_SESSION_ENTRIES 471
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MAX_SESSION_ENTRIES_DEFAULT_LENGTH 4
/**
 * This element represents the maximum BIB entries that can be created by the NAT device.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MAX_BIBENTRIES 472
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MAX_BIBENTRIES_DEFAULT_LENGTH 4
/**
 * This element represents the maximum NAT entries that can be created per user by the NAT device.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MAX_ENTRIES_PER_USER 473
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MAX_ENTRIES_PER_USER_DEFAULT_LENGTH 4
/**
 * This element represents the maximum subscribers or maximum hosts that are allowed by the NAT
 * device.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MAX_SUBSCRIBERS 474
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MAX_SUBSCRIBERS_DEFAULT_LENGTH 4
/**
 * This element represents the maximum fragments that the NAT device can store for reassembling the
 * packet.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MAX_FRAGMENTS_PENDING_REASSEMBLY 475
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_MAX_FRAGMENTS_PENDING_REASSEMBLY_DEFAULT_LENGTH 4
/**
 * This element represents the high threshold value of the number of public IP addresses in the
 * address pool.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_ADDRESS_POOL_HIGH_THRESHOLD 476
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_ADDRESS_POOL_HIGH_THRESHOLD_DEFAULT_LENGTH 4
/**
 * This element represents the low threshold value of the number of public IP addresses in the
 * address pool.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_ADDRESS_POOL_LOW_THRESHOLD 477
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_ADDRESS_POOL_LOW_THRESHOLD_DEFAULT_LENGTH 4
/**
 * This element represents the high threshold value of the number of address and port mappings.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_ADDRESS_PORT_MAPPING_HIGH_THRESHOLD 478
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_ADDRESS_PORT_MAPPING_HIGH_THRESHOLD_DEFAULT_LENGTH 4
/**
 * This element represents the low threshold value of the number of address and port mappings.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_ADDRESS_PORT_MAPPING_LOW_THRESHOLD 479
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_ADDRESS_PORT_MAPPING_LOW_THRESHOLD_DEFAULT_LENGTH 4
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_ADDRESS_PORT_MAPPING_PER_USER_HIGH_THRESHOLD 480
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_ADDRESS_PORT_MAPPING_PER_USER_HIGH_THRESHOLD_DEFAULT_LENGTH 4
/**
 * This element represents the high threshold value of the number of address and port mappings that
 * a single user is allowed to create on a NAT device in a paired address pooling behavior.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_GLOBAL_ADDRESS_MAPPING_HIGH_THRESHOLD 481
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_GLOBAL_ADDRESS_MAPPING_HIGH_THRESHOLD_DEFAULT_LENGTH 4
/**
 * VPN ID in the format specified by [RFC2685]. The size of this Information Element is 7 octets.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_VPN_IDENTIFIER 482
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_VPN_IDENTIFIER_DEFAULT_LENGTH 3
/**
 * BGP community as defined in [RFC1997]
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_BGP_COMMUNITY 483
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_BGP_COMMUNITY_DEFAULT_LENGTH 4
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_BGP_SOURCE_COMMUNITY_LIST 484
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_BGP_SOURCE_COMMUNITY_LIST_DEFAULT_LENGTH 64
/**
 * basicList of zero or more bgpCommunity IEs, containing the BGP communities corresponding with
 * destination IP address of a specific flow
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_BGP_DESTINATION_COMMUNITY_LIST 485
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_BGP_DESTINATION_COMMUNITY_LIST_DEFAULT_LENGTH 64
/**
 * BGP Extended Community as defined in [RFC4360]; the size of this IE MUST be 8 octets
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_BGP_EXTENDED_COMMUNITY 486
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_BGP_EXTENDED_COMMUNITY_DEFAULT_LENGTH 3
/**
 ...
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_BGP_SOURCE_EXTENDED_COMMUNITY_LIST 487
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_BGP_SOURCE_EXTENDED_COMMUNITY_LIST_DEFAULT_LENGTH 64
/**
 * basicList of zero or more bgpExtendedCommunity IEs, containing the BGP Extended Communities
 * corresponding with destination IP address of a specific flow
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_BGP_DESTINATION_EXTENDED_COMMUNITY_LIST 488
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_BGP_DESTINATION_EXTENDED_COMMUNITY_LIST_DEFAULT_LENGTH 64
/**
 * BGP Large Community as defined in [RFC8092]; the size of this IE MUST be 12 octets.
 */
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_BGP_LARGE_COMMUNITY 489
#define DOCA_TELEMETRY_EXPORTER_NETFLOW_BGP_LARGE_COMMUNITY_DEFAULT_LENGTH 3

#endif /* DOCA_TELEMETRY_EXPORTER_NETFLOW_TYPES_H_ */
