 ...
 */
#define DOCA_VERSION_PATCH 109
/**
 * @brief DOCA Version String.
 */
#define DOCA_VERSION_STRING "3.3.0109"
...
/**
 * @brief Check if the specified version is less than or equal to current official version.
 */
